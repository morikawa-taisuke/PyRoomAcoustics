...
if __name__ == "__main__":
	...
	base_dir = "C:/Users/kataoka-lab/Desktop/sound_data/mix_data/dataset_1ch_random_rt60_snr_v1/train"
	room_list = mymodule.my_func.get_subdir_list(base_dir)
	# print(room_list)
	for room in room_list:
		metadata_path = Path(os.path.join(base_dir, room, "metadata.json"))
		output_dir = Path(os.path.join(base_dir, room, "rirs"))
