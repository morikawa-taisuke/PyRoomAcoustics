...
if __name__ == '__main__':
    ...
    #     output_dir =  f"C:/Users/kataoka-lab/Desktop/sound_data/mix_data/DEMAND_1ch/condition_{i}/noise_reverbe"
    #     main(csv_path, speech_dir, noise_dir, ir_dir, output_dir)
