...
def recoding3(wave_files, out_dir, snr, reverbe_sec, reverbe_par, channel=1, distance=0, is_split=False, angle=np.pi, angle_name:str="None"):
    """ シミュレーションを用いた録音 (部屋のパラメータを計算済み)
...
if __name__ == "__main__":
    ...
    angle_list = [math.radians(i) for i in [0, 30, 45, 60, 90]]
    angle_name_list = ["00dig", "30dig", "45dig", "60dig", "90dig"] # "Right", "FrontRight", "Front", "FrontLeft", "Left"
    print(angle_list)
